...
const experts: Expert[] = [
  {
    ...
    paragraphs: [
      "Dr Olivia Ly Lesslar is an Australian medical doctor recognised internationally for her work in psychoneuroimmunology and complex-condition medicine - integrating neuroscience, immunology, and behavioural science with creative reasoning and systems-level thinking.",
      "In 2025, she completed a seven-city speaking tour across Australia and New Zealand presenting her original framework, The Nine Ancient Survival Threats, exploring the evolutionary and neurobiological roots of modern chronic disease.",
      "Dr Lesslar is Director of Functional and Longevity Medicine at Cingulum Health in Sydney, where she integrates neuroplastic and transcranial magnetic stimulation therapies with functional medicine for neurological and psychiatric care. She also holds senior and advisory roles across more than thirty organisations spanning biotechnology, neurotechnology, longevity, and wellness.",
      "She serves as a Director of the British College of Functional Medicine (UK) and holds academic appointments with Griffith University’s National Centre for Neuroimmunology and Emerging Diseases and the Geneva College of Longevity Science.",
    ],
    links: [
      { label: "drolivialesslar.com", href: "https://www.drolivialesslar.com" },
      {
        label: "TEDx · Take Control of Your Lifestyle-Driven Disease",
        href: "https://youtu.be/dMw5u5VCTxU",
      },
